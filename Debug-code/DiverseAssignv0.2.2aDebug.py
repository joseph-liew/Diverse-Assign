...
###############################################
'''
# debug_print(message, variable, bool): prints a variable for debug tracing
...
def assigner(num_groups, num_rows, data):
    ...
    # if debug_flag:
    #     data.to_csv('PreAssignIndexedDataV0_2_2a.csv', index = True)
    ...
    while temperature > 0.01:
        ...
        # debug_print("Progress percentage of current solution:", (1 - temperature), True)
    
    # Intermediary check for future debugging
    # if debug_flag:
    #     data.to_csv("AssignerOutputV0_2_2a.csv")
...
# Intermediary check for future debugging
# if debug_flag:
#     data.to_csv('IndexedInputV0_2_2a.csv', index = True)
