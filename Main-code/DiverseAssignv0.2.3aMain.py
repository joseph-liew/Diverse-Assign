# -*- coding: utf-8 -*-
"""
Created on Mon Jan 1 07:53:12 2024
Updated on Mon Jan 22 13:11:20 2024
@author: Joseph
"""
import sys
import os
...
def assigner(num_groups, num_rows, data):
    ...
    while temperature > 0.001:
        ...
        for index, i in data.iterrows():
            ...
            # prevent row swapping within the same group 
            elif assign_i == assign_j:
                continue
                ...
                # There is a proability to reject this swap and move to the next index in the "for index" loop
                if delta_diversity > 0:
                    current_diversity = new_diversity
                    previous_index.add(index)
                    
                else:
                    if np.random.uniform(0,indices_lst_size) < np.exp(delta_diversity / temperature): 
...
while True:
    ...
    try:
        ...
        num_rows = len(data)
        print()
        print(f"... there are {num_rows} of participants in total.")
...
print()
print(f"Eliminating {eliminated_count:,} eliminated_count solutions.")

print()
print(f"Now simplifing to {instance_count:,} solutions.")
print("... working...")

time.sleep(20) # The time delay here is for UX purpose only. It is to give 20 seconds to the user to read how long this programme will take.
